...
/**
 * Created by earyant on 2017 : 09 : 2017/9/21 0021 : 10:09 : .
 * idc  com.earyant.config.mysql
 */
@Configuration
public class DruidConfiguration {
    ...
    public ServletRegistrationBean DruidStatViewServle2() {
        ...
        //登录查看信息的账号密码.
        servletRegistrationBean.addInitParameter("loginUsername", "earyant");
        servletRegistrationBean.addInitParameter("loginPassword", "earyant");
        //是否能够重置数据.
